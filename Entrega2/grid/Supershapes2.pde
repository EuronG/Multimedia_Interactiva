...
void drawSuperShapes(float amp, float frame) {
 ...
 float[] shape0 = {map(amp, 0, 1, shape1[0], shape2[0]),
                   ...
                   map(amp, 0, 1, shape1[2], shape2[2]),
                   map(amp, 0, 1, shape1[3], shape2[3]),
                   map(amp, 0, 1, shape1[4], shape2[4]),
                   map(amp, 0, 1, shape1[5], shape2[5]),
                   map(amp, 0, 1, shape1[6], shape2[6]),
                   map(amp, 0, 1, shape1[7], shape2[7])};
 //noStroke();
 
 float r = map(amp, 0, 1, 100, 350);
 for (int i = 0; i < total+1; i++) {
